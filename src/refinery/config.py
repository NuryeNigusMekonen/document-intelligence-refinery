...
class Settings(BaseSettings):
    ...
    vlm_low_budget_cap_usd: float = Field(default=1.0)
    vlm_low_cost_page_cost_estimate: float = Field(default=0.08)
    vlm_high_quality_page_cost_estimate: float = Field(default=0.12)
    vlm_request_timeout_seconds: int = Field(default=60)
